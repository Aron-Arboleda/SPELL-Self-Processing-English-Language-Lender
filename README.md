...
## Instructions
### To use the app
* download the [SPELL Installer .exe file](https://github.com/Aron-Arboleda/SPELL-Self-Processing-English-Language-Lender/tree/main/dist) file under the dist folder, and install the application.
